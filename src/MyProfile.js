        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ color: "#6b7280", fontSize: "12px", marginBottom: "4px" }}>보유 현금</div>
              <div style={{ color: "#10b981", fontSize: "18px", fontWeight: "700" }}>
                {formatKoreanCurrency(cash)}
              </div>
            </div>
            <div style={{
              background: "#0f0f23",
              ...
              <div style={{ color: "#6b7280", fontSize: "12px", marginBottom: "4px" }}>주식 평가액</div>
              <div style={{ color: "#3b82f6", fontSize: "18px", fontWeight: "700" }}>
                {formatKoreanCurrency(stockValue)}
              </div>
            </div>
            <div style={{
              background: "#0f0f23",
              ...
              <div style={{ color: "#6b7280", fontSize: "12px", marginBottom: "4px" }}>부동산 평가액</div>
              <div style={{ color: "#f59e0b", fontSize: "18px", fontWeight: "700" }}>
                {formatKoreanCurrency(realEstateValue)}
              </div>
            </div>
            <div style={{
              background: "#0f0f23",
              ...
              <div style={{ color: "#6b7280", fontSize: "12px", marginBottom: "4px" }}>아이템 가치</div>
              <div style={{ color: "#a78bfa", fontSize: "18px", fontWeight: "700" }}>
                {formatKoreanCurrency(itemValue)}
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ color: "#9ca3af", fontSize: "12px", marginBottom: "4px" }}>총 순자산</div>
            <div style={{ color: "#a78bfa", fontSize: "24px", fontWeight: "800" }}>
              {formatKoreanCurrency(netAssets)}
            </div>
          </div>
        </div>
